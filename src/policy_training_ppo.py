...
if config_name == "125M":
    ...
    default_config.train.total_steps = 640
    default_config.model.model_path = "./checkpoint/policy_checkpoint/pythia-1b-deduped" # "Dahoas/pythia-1B-static-sft"
    default_config.tokenizer.tokenizer_path = "./checkpoint/policy_checkpoint/pythia-1b-deduped" #"Dahoas/pythia-1B-static-sft"
    default_config.method.chunk_size = 4
...
def create_reward_fn():  # noqa:  C901
    reward_tokenizer = AutoTokenizer.from_pretrained("./checkpoint/policy_checkpoint/pythia-1.4b")
    ...
    if triton_host:
        ...
        reward_model = RewardModel("./checkpoint/policy_checkpoint/pythia-1.4b", reward_tokenizer.eos_token_id)
...
if __name__ == "__main__":
    ...
    dataset= load_dataset("json", data_files = "/home/ubuntu/AIHF_hh/data/HH_RL.json")
    eval_prompts = load_dataset("json", data_files = "/home/ubuntu/AIHF_hh/data/HH_RL.json")
