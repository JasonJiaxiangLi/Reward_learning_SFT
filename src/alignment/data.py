...
preprocessed_list = ["generated/hh_processed", "generated/winogrande_processed"]
...
def mix_datasets(dataset_mixer: dict, splits: Optional[List[str]] = None, shuffle=True) -> DatasetDict:
    ...
    raw_val_datasets = []
    fracs = []
    # print(f"dataset_mixer is {dataset_mixer}")
    for ds, frac in dataset_mixer.items():
        ...
        for split in splits:
            try:
                ...
                # dataset = load_dataset('json', data_files=os.path.join(ds, split + ".jsonl"))# , split=split)
